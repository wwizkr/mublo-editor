...
return [
    ...
    // =========================================================================
    // 문서 변환 설정 (plugins/import/convert.php)
    // =========================================================================

    // PDF 텍스트 추출용 pdftotext(poppler) 절대 경로.
    // 미지정(null) 시 PATH 및 표준 위치에서 자동 탐색한다.
    // 서버 PATH 에 없다면 절대 경로 지정 (예: 'C:\\poppler\\bin\\pdftotext.exe').
    // 'pdftotext_bin' => null,
];
